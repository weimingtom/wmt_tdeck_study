...
#define PIN_NUM_MISO 38//25
#define PIN_NUM_MOSI 41//23
#define PIN_NUM_CLK  40//19
#define PIN_NUM_CS   12//22

#define PIN_NUM_DC   11//21
#define PIN_NUM_RST  17//RADIO_RST_PIN==17, -1//18
#define PIN_NUM_BCKL 42//5

#define LCD_BK_LIGHT_ON_LEVEL   1//0
...
void lcd_init(spi_device_handle_t spi)
{
    ...
    io_conf.pin_bit_mask = ((1ULL << PIN_NUM_BCKL) | (1ULL << BOARD_POWERON));
    io_conf.mode = GPIO_MODE_OUTPUT;
    io_conf.pull_up_en = true;
    gpio_config(&io_conf);
    ...
    printf("gpio_set_level %d, %d\n", PIN_NUM_BCKL, LCD_BK_LIGHT_ON_LEVEL);
}
