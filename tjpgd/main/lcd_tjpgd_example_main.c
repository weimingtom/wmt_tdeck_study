...
#define EXAMPLE_LCD_BK_LIGHT_ON_LEVEL  1//0
#define EXAMPLE_LCD_BK_LIGHT_OFF_LEVEL !EXAMPLE_LCD_BK_LIGHT_ON_LEVEL
#define EXAMPLE_PIN_NUM_DATA0          41//23  /*!< for 1-line SPI, this also refereed as MOSI */
#define EXAMPLE_PIN_NUM_PCLK           40//19
#define EXAMPLE_PIN_NUM_CS             12//22
#define EXAMPLE_PIN_NUM_DC             11//21
#define EXAMPLE_PIN_NUM_RST            17//RADIO_RST_PIN==17, -1//18
#define EXAMPLE_PIN_NUM_BK_LIGHT       42//5
